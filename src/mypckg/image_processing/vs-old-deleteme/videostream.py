...
from vs.webcamvideostream import WebcamVideoStream
from vs.filevideostream import FileVideoStream

class VideoStream:
	def __init__(self, src=0, usePiCamera=False, useFileVideo=False, resolution=(320, 240),framerate=32):
		...
		if usePiCamera:
			...
			from vs.pivideostream import PiVideoStream
		...
		# stream
			...
			self.stream = WebcamVideoStream(src=src,resolution=resolution, fps=framerate)
