...
class ModuleClass():
    ...
    def print_info_msg_as_root_logger(self):
        logging.info(
            "This is just a normal message of type INFO sent as root name send from inside ModuleClass")

    def print_info_msg_as_instance_logger(self):
        self.logger.info(
            "This is just a normal message of type INFO sent with the instance name")
